...
( id       INT(11) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  ...
  name     VARCHAR(80) CHARACTER SET utf8 NOT NULL COMMENT 'name of the region',
  CONSTRAINT fk_regions_countries_code FOREIGN KEY ( country ) REFERENCES countries ( code )
)
;

CREATE INDEX index_regions_code ON regions ( code )
;

INSERT INTO regions ( created, modified, deleted, country, code, name )
VALUES ( SYSDATE(), NULL, NULL, '0', '0', '(not specified)' )
	 ...
	 , ( SYSDATE(), NULL, NULL, 'DE', 'HG', 'Bad Homburg' )
	 , ( SYSDATE(), NULL, NULL, 'DE', 'Z', 'Zwickau' )
;
