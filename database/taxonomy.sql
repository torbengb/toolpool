...
( id       INT(11) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  ...
  name     VARCHAR(50) CHARACTER SET utf8 NOT NULL COMMENT 'name of the taxonomy',
  parent   INT(11) UNSIGNED                        DEFAULT 0 COMMENT 'taxonomy.id of the parent of this taxonomy, or zero for top level'
,CONSTRAINT fk_taxonomy_taxonomy_parent FOREIGN KEY ( parent ) REFERENCES taxonomy ( id )
)
;

CREATE INDEX index_taxonomy_id ON taxonomy ( id )
;

INSERT INTO taxonomy ( id, created, modified, deleted, name, parent )
VALUES ( 1, SYSDATE(), NULL, NULL, '(none)', 1 )
