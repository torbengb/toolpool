CREATE TABLE IF NOT EXISTS tools (
  ...
  taxonomy1 INT(11) NOT NULL DEFAULT 2 COMMENT 'taxonomy.id of the broadest classification of this tool',
  taxonomy2 INT(11)     NULL DEFAULT 1 COMMENT 'taxonomy.id of the classification',
  taxonomy3 INT(11)     NULL DEFAULT 1 COMMENT 'taxonomy.id of the classification',
  taxonomy4 INT(11)     NULL DEFAULT 1 COMMENT 'taxonomy.id of the classification',
  taxonomy5 INT(11)     NULL DEFAULT 1 COMMENT 'taxonomy.id of the narrowest classification of this tool',
